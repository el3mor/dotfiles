...
hl.bind(
    "Print",
     hl.dsp.exec_cmd("grimblast --notify copy screen"),
    { locked = true }
)

hl.bind(
    "SHIFT + Print",
    hl.dsp.exec_cmd("grimblast --notify save area ~/Pictures/Screenshots/$(date +'%Y-%m-%d_%H-%M-%S').png"),
    { locked = true }
)
...
hl.bind(
   mainMod .. " + Print",
       hl.dsp.exec_cmd("grimblast --notify save screen ~/Pictures/Screenshots/$(date +'%Y-%m-%d_%H-%M-%S').png"),
    { locked = true }
)
